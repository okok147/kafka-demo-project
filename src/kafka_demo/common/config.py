...
class Settings:
    ...
    postgres_dsn: str = os.environ.get("POSTGRES_DSN", os.environ.get("DATABASE_URL", ""))
    ...
    order_api_port: int = int(os.environ.get("PORT", os.environ.get("ORDER_API_PORT", "8000")))
    query_api_port: int = int(os.environ.get("PORT", os.environ.get("QUERY_API_PORT", "8080")))
